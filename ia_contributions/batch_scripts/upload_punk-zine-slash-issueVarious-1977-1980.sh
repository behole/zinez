...
# Upload punk-zine-slash-issueVarious-1977-1980
ia upload \
  "punk-zine-slash-issueVarious-1977-1980" \
  --metadata="title:Slash" \
  --metadata="mediatype:texts" \
  --metadata="collection:opensource" \
  --metadata="description:Important LA punk zine

Punk zine from Los Angeles, USA
Published: 1977-1980

Featured bands: X, The Germs, Black Flag

---
Contributed by the Punk Zines Research Project
Part of documenting underground punk culture and DIY publishing" \
  --metadata="subject:LA punk; California; 1970s; punk" \
  --metadata="creator:Steve Samiof, Melanie Nissen" \
  --metadata="date:1977-1980" \
...
echo "View at: https://archive.org/details/punk-zine-slash-issueVarious-1977-1980"